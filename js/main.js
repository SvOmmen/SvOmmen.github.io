...
//	defaultpage function
	function defaultdiv(){
		...
		content = 
			...
			'<BR><button type="button" class="button" id="Participate">Participate!</button>'
			addContent();	
		pickdiv = "centernav"
		newclass = "links"
...
// Work
	function prospub(){
		$('#center').empty();
			...
			newclass =  "info"
			content=
			'<p><img src="./gifs/prosody.gif" alt="Prosody" class="center"><BR><button class="refbutton" onclick="location.href=`https://www.nature.com/articles/s41598-022-17401-x`"><span style="color: grey">2022</span>Peter, V., van Ommen, S., Kalashnikova, M., Mazuka, R., Nazzi, T. and Burnham, D. Language-specific speech processing: Cortical tracking to speech rhythm at mora, syllable, and foot levels Scientific Reports 12:13477</button><button type="button" class="brain"></button><button type="button" class="prosody"></button><BR><button class="refbutton" onclick="location.href=`https://www.cambridge.org/core/journals/phonology/article/abs/shlomo-izreel-heliana-mello-alessandro-panunzi-and-tommaso-raso-eds-2020-in-search-of-basic-units-of-spoken-language-a-corpusdriven-approach-studies-in-corpus-linguistics-94-amsterdam-philadelphia-john-benjamins-publishing-company-pp-xi-440/B714CD04EEF5104E7D19A4C611BAF9EC`"><span style="color: grey">2021</span> van Ommen, S. Shlomo Izre\'el, Heliana Mello, Alessandro Panunzi and Tommaso Raso (eds.) (2020). In search of basic units of spoken language: a corpus-driven approach. (Studies in Corpus Linguistics 94.) Amsterdam & Philadelphia: John Benjamins Publishing Company. Pp. xi + 440. Phonology, 38, 2, 357-362</button><button type="button" class="prosody"></button><button type="button" class="speech"></button><BR><button class="refbutton" onclick="location.href=`https://www.sciencedirect.com/science/article/abs/pii/S0749596X2030022X`"><span style="color: grey">2020</span> van Ommen, S., Boll-Avetisyan, N., Larraza, S., Wellmann, C., Bijeljac-Babic, R., Hohle, B.;Nazzi, T. Language-specific prosodic acquisition: a comparison of phrase boundary perception by French- and German-learning infants. Journal of Memory and Language 112, 104108</button><button type="button" class="acquisition"></button><button type="button" class="prosody"></button><BR><button class="refbutton" onclick="location.href=`./documents/BollAvetisyanetal(2018)NeuralResponseDevelopment.pdf`"><span style="color: grey">2018</span> Boll-Avetisyan, N., Nixon, J., Lentz, T., Liu, L., van Ommen, S., Coltekin, C., and van Rij,J. Neural response development during distributional learning, Proceedings of Interspeech 2018,Iderabad, India.</button><button type="button" class="brain"></button><button type="button" class="prosody"></button><BR><button class="refbutton" onclick="location.href=`./documents/Nixonetal(2018)Shortterm.pdf`"><span style="color:grey">2018</span> Nixon, J.S, Boll-Avetisyan, N. Lentz, T. O., van Ommen, S., Keij, B., Coltekin, C., Liu, L.,and van Rij, J. Short-term exposure enhances perception of both between- and within-category acoustic information. Proceedings of Speech Prosody 2018.</button><button type="button" class="brain"></button><button type="button" class="prosody"></button><BR><button class="refbutton" onclick="location.href=`./documents/vanOmmen(2016)Listentothebeat.pdf`"><span style="color:grey">2016</span> van Ommen, S. Listen to the beat: A cross-linguistic perspective on the use of stress in segmentation.Doctoral dissertation, Utrecht University. Published by LOT (Landelijke Onderzoeksschool Taalwetenschap).</button><button type="button" class="prosody"></button><BR><button class="refbutton" onclick="location.href=`./documents/vanOmmenKager(2012)Progressiveuseofmetricalcues.pdf`"><span style="color:grey">2012</span> van Ommen, S. and R.W.J. Kager. Progressive Use of Metrical Cues: a Cross-linguistic Study.In: Proceedings of NLPCS 2012, 9th International Workshop on Natural Language Processing and Cognitive Science, Wroclaw, Poland, p. 74-84.</button><button type="button" class="prosody"></button></p>' 
			addContent();
			// Publication subsets event
			const divs = document.querySelectorAll('.prosody');
			divs.forEach(el => el.addEventListener('click', event => {
	...
	function speechpub(){
		$('#center').empty();
			...
			newclass =  "info"
			content=
			'<p><img src="./gifs/speech.gif" alt="Speech" class="center"><BR><button class="refbutton" onclick="location.href=`https://www.tandfonline.com/doi/abs/10.1080/15475441.2022.2071717`"><span style="color: grey">2022</span>Von Holzen, K., van Ommen,S., White, K., and Nazzi, T. The impact of phonological biases on mispronunciation sensitivity and novel accent adaptation. Language Learning and Development</button><button type="button" class="acquisition"></button><BR><button type="button" class="speech"></button><BR></button><button class="refbutton" onclick="location.href=`https://www.cambridge.org/core/journals/phonology/article/abs/shlomo-izreel-heliana-mello-alessandro-panunzi-and-tommaso-raso-eds-2020-in-search-of-basic-units-of-spoken-language-a-corpusdriven-approach-studies-in-corpus-linguistics-94-amsterdam-philadelphia-john-benjamins-publishing-company-pp-xi-440/B714CD04EEF5104E7D19A4C611BAF9EC`"><span style="color: grey">2021</span> van Ommen, S. Shlomo Izre\'el, Heliana Mello, Alessandro Panunzi and Tommaso Raso (eds.) (2020). In search of basic units of spoken language: a corpus-driven approach. (Studies in Corpus Linguistics 94.) Amsterdam & Philadelphia: John Benjamins Publishing Company. Pp. xi + 440. Phonology, 38, 2, 357-362</button><button type="button" class="prosody"></button><button type="button" class="speech"></button><BR><button class="refbutton" onclick="location.href=`./documents/vanOmmenetal(2007)Heeelelangevocalen.pdf`"><span style="color:grey">2007</span> van Ommen, S., J. Hoeksema and D.G. Gilbers. Heeeeele lange vocalen: een onderzoek naar emfatische rekking, TABU, 36-1/2, 39-64</button><button type="button" class="speech"></p>'
			addContent();
			// Publication subsets event
			const divs = document.querySelectorAll('.prosody');
			divs.forEach(el => el.addEventListener('click', event => {
	...
	function visionpub(){
		$('#center').empty();
			...
			newclass =  "info"
			content=
			'<p><img src="./gifs/vision.gif" alt="Vision" class="center"><BR><button class="refbutton" onclick="location.href=`https://direct.mit.edu/jocn/article-abstract/33/6/984/98363/Visual-Predictions-Operate-on-Different-Timescales`"><span style="color: grey">2021</span> Darriba, A, van Ommen, S., Hsu, Y-F, Waszak, F. Visual predictions operate on different time-scales. Journal of Cognitive Neuroscience 33, 6, 984-1002</button><button type="button" class="brain"></button><button type="button" class="vision"></button><BR><button class="refbutton" onclick="location.href=`./documents/Darribaetal(2021)Differenttimescales.pdf`"><span style="color: grey">2021</span> Darriba, A, van Ommen, S., Hsu, Y-F, Waszak, F. Visual predictions operate on different time-scales. Journal of Cognitive Neuroscience</button><button type="button" class="brain"></button><button type="button" class="vision"></button><BR><button type="button" class="refbutton" onclick="location.href=`./documents/Heloetal(2017)Semanticconsistency.pdf`"><span style="color: grey">2017</span> Helo, A., van Ommen, S., Pannasch, S., Danteny-Dordoigne, L., Rama, P. Influence of semantic consistency and perceptual features on visual attention during scene viewing in toddlers, Infant Behavior and Development, 49, 248-266.</button><button type="button" class="vision"></button></p>'
			addContent();
			// Publication subsets event
			const divs = document.querySelectorAll('.prosody');
			divs.forEach(el => el.addEventListener('click', event => {
...
// 	Participate function
	function Participate(){
		...
		newclass = "info"
		content = 	
		'<center><p><b>Are you a native speaker of Swiss French, Swiss German or Swiss Italian</b>?<BR><BR> <button class="contact" onclick="location.href=`mailto:languagecognition.msca.eu@gmail.com`">Contact me</button> <BR><BR> to participate in an experiment.<BR> I am currently testing in Geneva, Zürich and Lugano and I only need about 2.5 hours of your time, for which you will be financially compensated. You will be listening to radio fragments while I record your brain activity (non-invasively). How does that sound?</p><BR><BR><BR><p><b>Would you like to be involved in some other way, for instance with an internship or a collaboration?</b> <BR><BR> <button class="contact" onclick="location.href=`mailto:sandrienvo@gmail.com`">Contact me</button><BR><BR> I\'m looking forward to it.</p>'+
		'<center><a onclick="location.href=`mailto:sandrienvo@gmail.com`"><img src="./images/portrait.JPG" width="400" alt="portrait" id="portrait"></a>'		
		addContent();	
	} 