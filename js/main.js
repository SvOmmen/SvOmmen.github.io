...
//	defaultpage function
	function defaultdiv(){
		pickdiv = 'center'
			...
			'<img src="./images/logoCBC.PNG" alt="CBC" id="logo3">'+
			'<img src="./images/logouilots.jpg" alt="UiL OTS" id="logo4">'+
			'<img src="./images/logoincc.png" alt="INCC" id="logo5">'+
			'<BR><BR><BR><BR><BR><BR>'+
		...
		content = 
			...
			'<BR><button type="lab" class="labbutton" id="labbutton">Marie Sklodowska Curie Fellow<BR> University of Geneva, Lab Anne-Lise Giraud<span class="tooltiptext">sandrien.vanommen[at]unige.ch</span></button>'+
